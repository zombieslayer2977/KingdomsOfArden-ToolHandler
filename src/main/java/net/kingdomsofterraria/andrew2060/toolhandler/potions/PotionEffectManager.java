package net.kingdomsofterraria.andrew2060.toolhandler.potions;

import java.util.Collection;
import java.util.concurrent.ConcurrentHashMap;

import net.kingdomsofterraria.andrew2060.toolhandler.ToolHandlerPlugin;
import net.kingdomsofterraria.andrew2060.toolhandler.listeners.potions.PotionEffectManagerListener;
import net.kingdomsofterraria.andrew2060.toolhandler.tasks.PotionUpdateRunnable;
