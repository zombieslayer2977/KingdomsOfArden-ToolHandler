...
public class ImprovementUtil {
    ...
    public static void setWeaponQuality(ItemStack item, double quality) {
        ...
        String toAdd = ChatColor.GRAY + "Improvement Quality: " + FormattingUtil.getWeaponToolQualityFormat(quality);
        lore.remove(1);
        lore.add(1, toAdd);
        meta.setLore(lore);
    ...
    public static double improveWeaponQuality(ItemStack item, int amount, double threshold) {
        ...
        toAdd = ChatColor.GRAY + "Improvement Quality: " + FormattingUtil.getWeaponToolQualityFormat(quality);
        lore.remove(1);
        lore.add(1, toAdd);
        meta.setLore(lore);
        item.setItemMeta(meta);
